...
class OneOfContainMatcherSpec extends Spec with Matchers with SharedHelpers {
  ...
  object `oneOf ` {
    ...
    def `should succeeded when left List contains same elements in same order as right List` {
      ...
      javaMap(1 -> "one", 3 -> "three", 5 -> "five", 8 -> "eight") should contain oneOf Map(7 -> "seven", 8 -> "eight", 9 -> "nine")
    }
    ...
    def `should work with ContainMatcher directly` {
      ...
      javaMap(1 -> "one", 2 -> "two", 3 -> "three") should contain oneOf Map(5 -> "five", 3 -> "three", 8 -> "eight")
    }
    ...
    def `should succeeded when right List contains more than one element in right List` {
      ...
      javaMap(1 -> "one", 2 -> "two", 3 -> "three") should contain oneOf Map(5 -> "five", 3 -> "three", 2 -> "two")
    }
    ...
    def `should succeeded when right List contains all elements in left List in different order` {
      ...
      javaMap(1 -> "one", 2 -> "two", 3 -> "three") should contain oneOf Map(1 -> "one", 3 -> "three", 2 -> "twp")
    }
    ...
    def `should succeeded when right List contains all elements in left List in same order` {
      ...
      javaMap(1 -> "one", 2 -> "two", 3 -> "three") should contain oneOf Map(1 -> "one", 2 -> "two", 3 -> "three")
    }
    ...
    def `should throw TestFailedException with correct stack depth and message when used with ContainMatcher directly` {
      ...
      val e12 = intercept[exceptions.TestFailedException] {
        left6 should contain oneOf Map(5 -> "five", 3 -> "three", 8 -> "eight")
      }
      checkStackDepth(e12, left6, Map(5 -> "five", 3 -> "three", 8 -> "eight"), thisLineNumber - 2)
    }
    ...
    def `should throw TestFailedException with correct stack depth and message when left and right List are same size but does not contain any same element` {
      ...
      val e3 = intercept[exceptions.TestFailedException] {
        left3 should contain oneOf Map(7 -> "seven", 8 -> "eight", 9 -> "nine")
      }
      checkStackDepth(e3, left3, Map(7 -> "seven", 8 -> "eight", 9 -> "nine"), thisLineNumber - 2)
      
      val left4 = javaMap(1 -> "one", 2 -> "two", 3 -> "three")
      val e4 = intercept[exceptions.TestFailedException] {
        left4 should contain oneOf Map(7 -> "seven", 8 -> "eight", 9 -> "nine")
      }
    ...
    def `should throw TestFailedException with correct stack depth and message when left List is shorter than right List and does not contain any same element` {
      ...
      val left3 = Map(1 -> "one", 2 -> "two", 3 -> "three")
      val e3 = intercept[exceptions.TestFailedException] {
        left3 should contain oneOf Map(6 -> "six", 7 -> "seven", 8 -> "eight", 9 -> "nine")
      }
      checkStackDepth(e3, left3, Map(6 -> "six", 7 -> "seven", 8 -> "eight", 9 -> "nine"), thisLineNumber - 2)
      
      val left4 = javaMap(1 -> "one", 2 -> "two", 3 -> "three")
      val e4 = intercept[exceptions.TestFailedException] {
        left4 should contain oneOf Map(6 -> "six", 7 -> "seven", 8 -> "eight", 9 -> "nine")
      }
      checkStackDepth(e4, left4, Map(6 -> "six", 7 -> "seven", 8 -> "eight", 9 -> "nine"), thisLineNumber - 2)
    }
    ...
    def `should throw TestFailedException with correct stack depth and message when left List is longer than right List and does not contain any same element` {
      ...
      val left3 = Map(1 -> "one", 2 -> "two", 3 -> "three")
      val e3 = intercept[exceptions.TestFailedException] {
        left3 should contain oneOf Map(8 -> "eight", 5 -> "five")
      }
      checkStackDepth(e3, left3, Map(8 -> "eight", 5 -> "five"), thisLineNumber - 2)
      
      val left4 = javaMap(1 -> "one", 2 -> "two", 3 -> "three")
      val e4 = intercept[exceptions.TestFailedException] {
        left4 should contain oneOf Map(8 -> "eight", 5 -> "five")
      }
      checkStackDepth(e4, left4, Map(8 -> "eight", 5 -> "five"), thisLineNumber - 2)
    }
  }
  ...
  object `not oneOf ` {
    ...
    def `should succeed when left List contains different elements as right List` {
      ...
      javaMap(1 -> "one", 2 -> "two", 3 -> "three") should not contain oneOf (Map(7 -> "seven", 8 -> "eight", 9 -> "nine"))
    }
    ...
    def `should work with ContainMatcher directly` {
      ...
      javaMap(1 -> "one", 2 -> "two", 8 -> "eight") should not contain oneOf (Map(5 -> "five", 7 -> "seven", 9 -> "nine"))
    }
    ...
    def `should throw TestFailedException with correct stack depth and message when used with ContainMatcher directly` {
      ...
      val e12 = intercept[exceptions.TestFailedException] {
        left6 should not contain oneOf (Map(5 -> "five", 7 -> "seven", 9 -> "nine"))
      }
      checkStackDepth(e12, left6, Map(5 -> "five", 7 -> "seven", 9 -> "nine"), thisLineNumber - 2)
    }
    ...
    def `should throw TestFailedException with correct stack depth and message when left and right List contain at least one same element` {
      ...
      val left3 = Map(1 -> "one", 2 -> "two", 3 -> "three")
      val e3 = intercept[exceptions.TestFailedException] {
        left3 should not contain oneOf (Map(5 -> "five", 1 -> "one", 7 -> "seven"))
      }
      checkStackDepth(e3, left3, Map(5 -> "five", 1 -> "one", 7 -> "seven"), thisLineNumber - 2)
      
      val left4 = javaMap(1 -> "one", 2 -> "two", 3 -> "three")
      val e4 = intercept[exceptions.TestFailedException] {
        left4 should not contain oneOf (Map(5 -> "five", 1 -> "one", 7 -> "seven"))
      }
      checkStackDepth(e4, left4, Map(5 -> "five", 1 -> "one", 7 -> "seven"), thisLineNumber - 2)
    }
    ...
    def `should throw TestFailedException with correct stack depth and message when left and right List contain more than one same element` {
      ...
      val left3 = Map(1 -> "one", 2 -> "two", 3 -> "three")
      val e3 = intercept[exceptions.TestFailedException] {
        left3 should not contain oneOf (Map(5 -> "five", 1 -> "one", 2 -> "two"))
      }
      checkStackDepth(e3, left3, Map(5 -> "five", 1 -> "one", 2 -> "two"), thisLineNumber - 2)
      
      val left4 = javaMap(1 -> "one", 2 -> "two", 3 -> "three")
      val e4 = intercept[exceptions.TestFailedException] {
        left4 should not contain oneOf (Map(5 -> "five", 1 -> "one", 2 -> "two"))
      }
      checkStackDepth(e4, left4, Map(5 -> "five", 1 -> "one", 2 -> "two"), thisLineNumber - 2)
    }
    ...
    def `should throw TestFailedException with correct stack depth and message when left and right List contain all same element in different order` {
      ...
      val left3 = Map(1 -> "one", 2 -> "two", 3 -> "three")
      val e3 = intercept[exceptions.TestFailedException] {
        left3 should not contain oneOf (Map(3 -> "three", 2 -> "two", 1 -> "one"))
      }
      checkStackDepth(e3, left3, Map(3 -> "three", 2 -> "two", 1 -> "one"), thisLineNumber - 2)
      
      val left4 = javaMap(1 -> "one", 2 -> "two", 3 -> "three")
      val e4 = intercept[exceptions.TestFailedException] {
        left4 should not contain oneOf (Map(3 -> "three", 2 -> "two", 1 -> "one"))
      }
      checkStackDepth(e4, left4, Map(3 -> "three", 2 -> "two", 1 -> "one"), thisLineNumber - 2)
    }
    ...
    def `should throw TestFailedException with correct stack depth and message when left and right List contain all same element in same order` {
      ...
      val left3 = Map(1 -> "one", 2 -> "two", 3 -> "three")
      val e3 = intercept[exceptions.TestFailedException] {
        left3 should not contain oneOf (Map(1 -> "one", 2 -> "two", 3 -> "three"))
      }
      checkStackDepth(e3, left3, Map(1 -> "one", 2 -> "two", 3 -> "three"), thisLineNumber - 2)
      
      val left4 = javaMap(1 -> "one", 2 -> "two", 3 -> "three")
      val e4 = intercept[exceptions.TestFailedException] {
        left4 should not contain oneOf (Map(1 -> "one", 2 -> "two", 3 -> "three"))
      }
      checkStackDepth(e4, left4, Map(1 -> "one", 2 -> "two", 3 -> "three"), thisLineNumber - 2)
    }
  }
}
