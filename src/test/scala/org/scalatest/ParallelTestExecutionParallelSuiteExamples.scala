...
class ExampleParallelTestExecutionParallelFeatureSpecPair extends ParallelSuites {
  ...
  def assertParallelSuites(events: List[Event]) {
    ...
    checkTestStarting(events(10), "Scope 2 Scenario: Test 4")
    checkTestSucceeded(events(11), "Scope 2 Scenario: Test 4")
    checkScopeClosed(events(12), "Scope 2")
    checkSuiteCompleted(events(13), suite1.suiteId)
    
    checkSuiteStarting(events(14), suite2.suiteId)
    checkScopeOpened(events(15), "Fixture Scope 1")
    checkTestStarting(events(16), "Fixture Scope 1 Scenario: Fixture Test 1")
    checkTestSucceeded(events(17), "Fixture Scope 1 Scenario: Fixture Test 1")
    checkTestStarting(events(18), "Fixture Scope 1 Scenario: Fixture Test 2")
    checkTestSucceeded(events(19), "Fixture Scope 1 Scenario: Fixture Test 2")
    checkScopeClosed(events(20), "Fixture Scope 1")
    checkScopeOpened(events(21), "Fixture Scope 2")
    checkTestStarting(events(22), "Fixture Scope 2 Scenario: Fixture Test 3")
    checkTestSucceeded(events(23), "Fixture Scope 2 Scenario: Fixture Test 3")
    checkTestStarting(events(24), "Fixture Scope 2 Scenario: Fixture Test 4")
    checkTestSucceeded(events(25), "Fixture Scope 2 Scenario: Fixture Test 4")
    checkScopeClosed(events(26), "Fixture Scope 2")
    checkSuiteCompleted(events(27), suite2.suiteId)
  }
}
