...
class ExampleParallelTestExecutionSuiteTimeoutFeatureSpecPair extends SuiteTimeoutSuites {
  ...
  def assertSuiteTimeoutTest(events: List[Event]) {
    ...
    checkTestStarting(events(4), "Scope 1 Scenario: Test 2")
    checkTestSucceeded(events(5), "Scope 1 Scenario: Test 2")
    checkScopeClosed(events(6), "Scope 1")
    checkScopeOpened(events(7), "Scope 2")
    checkTestStarting(events(8), "Scope 2 Scenario: Test 3")
    checkTestSucceeded(events(9), "Scope 2 Scenario: Test 3")
    checkSuiteCompleted(events(10), suite1.suiteId)
    
    checkSuiteStarting(events(11), suite2.suiteId)
    checkScopeOpened(events(12), "Fixture Scope 1")
    checkTestStarting(events(13), "Fixture Scope 1 Scenario: Fixture Test 1")
    checkTestSucceeded(events(14), "Fixture Scope 1 Scenario: Fixture Test 1")
    checkTestStarting(events(15), "Fixture Scope 1 Scenario: Fixture Test 2")
    checkTestSucceeded(events(16), "Fixture Scope 1 Scenario: Fixture Test 2")
    checkScopeClosed(events(17), "Fixture Scope 1")
    checkScopeOpened(events(18), "Fixture Scope 2")
    checkTestStarting(events(19), "Fixture Scope 2 Scenario: Fixture Test 3")
    checkTestSucceeded(events(20), "Fixture Scope 2 Scenario: Fixture Test 3")
    checkTestStarting(events(21), "Fixture Scope 2 Scenario: Fixture Test 4")
    checkTestSucceeded(events(22), "Fixture Scope 2 Scenario: Fixture Test 4")
    checkScopeClosed(events(23), "Fixture Scope 2")
    checkSuiteCompleted(events(24), suite2.suiteId)
    
    checkTestStarting(events(25), "Scope 2 Scenario: Test 4")
    checkTestSucceeded(events(26), "Scope 2 Scenario: Test 4")
    checkScopeClosed(events(27), "Scope 2")
  }
}
